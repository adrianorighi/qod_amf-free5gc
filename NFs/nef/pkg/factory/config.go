...
const (
	...
	ServiceQod         string = "qod"  // Novo serviço para QoD
)
...
const (
	...
	QodResUriPrefix 		 = "/" + ServiceQod + "/v1"  // Novo prefixo de URI QoD
)
...
func (c *Configuration) validate() (bool, error) {
	...
	for i, s := range c.ServiceList {
		...
		case ServiceNefPfd:
		case ServiceNefOam:
		case ServiceQod: // Novo serviço para QoD
		default:
...
func (c *Config) ServiceUri(name string) string {
	...
	case ServiceQod: // Novo serviço para QoD
		return c.SbiUri() + QodResUriPrefix
	default:
		return ""
	}
}
